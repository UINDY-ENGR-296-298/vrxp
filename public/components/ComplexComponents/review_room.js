  ...
  function buildRoom(root) {
    ...
    room.appendChild(
      makeTextPanel({
        ...
        z: portalZ-2,
        rotY: 0,
        value: "Alejandro Martinez Ramirez:\n“The virtual space is looking pretty good. So far it does look accurate to the actual campus. I didn't experience any weird glitches so far. Also our character is quite speedy.”",
        width: 4,
        height: 5,
        textWidth: 2,
        wrapCount: 14,
    ...
    room.appendChild(
      makeTextPanel({
        ...
        z: spawnZ - 7,
        rotY: 35,
        value: "Eric Cruz:\n“BRO. THIS IS CRAZY. Amazing. 10/10”\n\nColin Werner:\n“This tuff.”",
        width: 2,
        height: 3.75,
        textWidth: 2,
        wrapCount: 14,
    ...
    room.appendChild(
      makeTextPanel({
        ...
        z: -7,
        rotY: -90,
        value: "Gregory Mason:\n “I think that the work that you guys have so far is great. The main plaza that you guys have modeled is nicely detailed, I was able to recognize where I was instantly. I even recognized Martin hall as soon as I saw it. The controls were a little jarring because the movement speed was a bit too fast and dragging to look around felt a little odd, but I understand the speed may be boosted temporarily so that it doesn't take you guys forever to get around and see everything as you guys are still developing it. I didn't quite understand the nature of the VR pop up because I never got a prompt to allow any sort of access, but that may be because I was using my computer instead of my phone. Overall I would say that it looks incredibly promising and would be a fantastic addition to the Uindy registration website.”",
        width: 5,
        height: 5.5,
        textWidth: 3,
        wrapCount: 28,
    ...
    room.appendChild(
      makeTextPanel({
        ...
        z: -3,
        rotY: 90,
        value: "Stephanie Rios:\n “Your world works good, but need to complete the entire campus 🙂”",
        width: 3,
        height: 1.25,
        textWidth: 3,
        wrapCount: 28,
