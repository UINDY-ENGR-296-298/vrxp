  ...
  function buildRoom(root) {
    ...
    room.appendChild(
      makeTextPanel({
        ...
        z: spawnZ - 7,
        rotY: 35,
        value: "Welcome to the UIndy Virtual Campus. \n\n Control the player with WASD and Look around using the arrow keys or clicking and dragging the mouse. Explore the path to learn more.",
        width: 2,
        height: 3.75,
        textWidth: 2,
        wrapCount: 14,
    ...
    room.appendChild(
      makeTextPanel({
        ...
        z: -7,
        rotY: -90,
        value: "Try activating your objectives by clicking this panel.",
        width: 3,
        height: .5,
        textWidth: 3,
        wrapCount: 28,
    ...
    room.appendChild(
      makeTextPanel({
        ...
        z: -3,
        rotY: 90,
        value: "Objectives will act as your guide throughout the UIndy campus. You can click 'p' at any time to reset your objectives and press 'o' to skip an objectives.",
        width: 3,
        height: 1.25,
        textWidth: 3,
        wrapCount: 28,
