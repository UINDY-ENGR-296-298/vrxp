// Tree cluster for quick greenery
    AFRAME.registerComponent('tree-cluster', {
      schema: { count: {type:'number', default: 12}, radius_ft: {type:'number', default: 100} },
      init(){
        const d = this.data; const el = this.el; const R = d.radius_ft * FT;
        for (let i=0;i<d.count;i++){
          const a = Math.random()*Math.PI*2; const r= Math.random()*R;
